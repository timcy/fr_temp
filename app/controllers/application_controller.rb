class ApplicationController < ActionController::Base
  ...
  protected
	...
	def configure_permitted_parameters
  	...
  	devise_parameter_sanitizer.for(:sign_up) << :user_name << :first_name << :last_name << :role_id << :role_type 
  	# devise_parameter_sanitizer.for(:sign_in) << :user_name
  	# Overriding Devise default and adding the complete list of permitted params
